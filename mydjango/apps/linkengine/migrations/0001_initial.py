...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Link'
        db.create_table(u'linkengine_link', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('sub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'linkengine', ['Link'])

        # Adding model 'Vote'
        db.create_table(u'linkengine_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linkengine.Link'])),
        ))
        db.send_create_signal(u'linkengine', ['Vote'])


    def backwards(self, orm):
        # Deleting model 'Link'
        db.delete_table(u'linkengine_link')

        # Deleting model 'Vote'
        db.delete_table(u'linkengine_vote')
    ...
    models = {
        ...
        u'linkengine.link': {
            ...
            'sub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'linkengine.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linkengine.Link']"}),
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }

    complete_apps = ['linkengine']